...
namespace LightShaft.Scripts
{
    public class YoutubePlayer : YoutubeSettings
    {
        ...
        public Button _firstPlayButton;
        ...
        public override void Start()
        {
            ...
            _playButton.onClick.AddListener(VideoManager.Instance.PlayPauseVideoPlayer);
            _fullScreenButton.onClick.AddListener(VideoManager.Instance.ToogleFullScreen);
            ToogleFullsScreenMode(); // Fix
            firstPlay = true;
        }
        ...
        {
            string tempId = url.Replace("https://www.youtube.com/watch?v=", "");
            StartCoroutine(DownloadThumbnail(tempId));
            Debug.Log("PreloadVideo");
            logTest = "Getting URL";
            Stop();
